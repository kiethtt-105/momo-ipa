...
// Fallback mặc định lấy từ env nếu route gọi không truyền storeId/storeName
 ...
 * @param {string} [params.storeId]   - Mã cửa hàng (optional, không nằm trong signature)
 * @param {string} [params.storeName] - Tên cửa hàng (optional, không nằm trong signature)
 */
