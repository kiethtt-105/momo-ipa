...
export async function createMoMoPayment({
  ...
  // DEBUG TẠM: kiểm tra MoMo có thực sự trả deeplink hay không, và có field
  // nào khác (applink/deeplinkMiniApp) chứa giá trị mà code hiện đang bỏ
  // sót không. Xoá log này sau khi xác nhận xong.
  console.log('[MoMo][createMoMoPayment] raw response fields:', {
    orderId,
    payUrl: data.payUrl,
